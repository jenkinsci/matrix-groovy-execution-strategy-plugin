...
/**
 * Groovy filter script that accepts or rejects matrix {@link hudson.matrix.Combination}.
 * <p/>
...
class FilterScript {
    ...
    /**
     * @param context Variables the script will see.
     */
     ...
     * <p/>
     * <p/>
     * This is bit like {@link hudson.matrix.Combination#toIndex(hudson.matrix.AxisList)}, but instead
